    ...
    <jsp:include page="navbardeep.jsp"></jsp:include>
        ...
        <div class="container">
            <div class="banner-info text-center">
                ...
                <form:form class="form-horizontal" action="${pageContext.request.contextPath}/flooring/viewsearch" method="get">

                </form:form>   

                <form:form class="form-horizontal" action="${pageContext.request.contextPath}/flooring/viewsearchall" method="get">

                    <div class="form-group">
                        <label for="add-search2" class="col-md-2 control-label">Search all:</label>
                        <div class="col-md-8">
                            <input type="text" name="search1" class="form-control" id="add-search" placeholder="Please enter a name for an Order"/> 
