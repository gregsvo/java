...
<body>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="invoice-title">
                        <h2>OLIVIERI FLOORING</h2><h3 class="pull-right">INVOICE <a href="${pageContext.request.contextPath}/flooring/showEdit/${order.order_id}/${order.date}">Order #${order.order_id}</a></h3>
    ...
    <!-- <div class="container">
            ...
            <div class="row">
                ...
                <p><h1>#${order.order_id} - ${order.customerName}</h1></p>
