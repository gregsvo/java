...
public interface OrderDao {
    ...
    Order createOrder(String fileName, String date, String customerName, String state, String productType, double area);

    Order editOrder(Order order, String customerName, String state, String productType, Double area, String date, String fileName);
