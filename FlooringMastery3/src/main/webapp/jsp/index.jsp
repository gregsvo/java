            ...
            <div class="container">
                ...
                <table id="orderTable" class="table">                
                    ...
                    <c:forEach items="${orderList}" var="order">
                        <tr id='newOrderRow-${order.orderNumber}'>
                            <td><a data-order-id="${order.orderNumber}" data-toggle="modal" data-target="#showOrderModal">${order.orderNumber}</a></td>
                            <td><a data-order-id="${order.orderNumber}" data-toggle="modal" data-target="#showOrderModal">${order.customerName}</a></td>
                            <td><a data-order-id="${order.orderNumber}" data-toggle="modal" data-target="#editOrderModal">Edit</a></td>
                            <td><a data-order-id="${order.orderNumber}" class="delete-link">Delete</a></td>                           
                        </tr>
                    </c:forEach>   
