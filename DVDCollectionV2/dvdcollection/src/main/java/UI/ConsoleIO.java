...
//BEGIN: getUserInputInt    
    ...
    public int getUserInputInt(String question, int min, int max, boolean equalTo) {
        ...
        String userResponse = "";
        int userInt = 0;
        String eMsg = "\nSorry, please enter a menu choice of 1 through 7.";
...
//BEGIN: getUserInputFloat
    ...
    public int getUserInputYear(String question) {
        boolean isValidDate = false;
        String userResponse = "";
        int userInt = 0;
        String eMsg = "\nPlease choose a year from 1900-" + Calendar.getInstance().get(Calendar.YEAR);
        ...
        while (!isValidDate) {
            try {
                ...
                if ((userInt > (Calendar.getInstance().get(Calendar.YEAR))) || (userInt < 1900)) {
                ...
                print("INVALID ENTRY. Date must be in this format: YYYY");
            }
        }
        return userInt;
    }
